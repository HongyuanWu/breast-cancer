...
```{r heatmap-sample-dist, fig.height = 6, out.width="80%", fig.cap="Heatmap of distance between samples"}
...
Prior to testing any models, it was necessary to normalise the test data to reflect changes made to the train data, i.e. to centre and scale the data using the column means and standard deviations calculated from the train set. This approach allows for the test set to be normalised in a way that is consistent with the train set.
...
model_results %>%
  ...
  pack_rows(index = c("Random sampling" = 2,
                      ...
                      "Ensemble" = 1)) %>%
  footnote(general = "FNR = false negative rate; FPR = false positive rate")
```
